...
namespace ProjetoCaixeiroViajante {
	...
	/// <summary>
	/// Summary for TelaTeoria7
	/// </summary>
	public ref class TelaTeoria7 : public System::Windows::Forms::Form
	{
	public:
		TelaTeoria7(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(TelaTeoria7::typeid));
			...
			this->btn_Avancar->Click += gcnew System::EventHandler(this, &TelaTeoria7::btn_Avancar_Click_1);
			// 
			// BotaoVoltarMenu
			// 
			...
			this->BotaoVoltarMenu->Click += gcnew System::EventHandler(this, &TelaTeoria7::BotaoVoltarMenu_Click_1);
			// 
			// TelaTeoria7
			// 
			...
			this->Name = L"TelaTeoria7";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"TelaTeoria7";
			this->Load += gcnew System::EventHandler(this, &TelaTeoria7::TelaTeoria7_Load);
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void TelaTeoria7_Load(System::Object^  sender, System::EventArgs^  e) {
	}
	...
	private: System::Void btn_Avancar_Click_1(System::Object^  sender, System::EventArgs^  e)
	{
		this->Visible = false;
		Close();
		TelaTeoria8 telateoria8;
		telateoria8.ShowDialog();
		this->Visible = true;
	}
