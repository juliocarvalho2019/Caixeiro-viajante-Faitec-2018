...
namespace ProjetoCaixeiroViajante {
	...
	/// <summary>
	/// Summary for TelaTeoria3
	/// </summary>
	public ref class TelaTeoria3 : public System::Windows::Forms::Form
	{
	public:
		TelaTeoria3(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(TelaTeoria3::typeid));
			...
			this->BotaoVoltarMenu->Location = System::Drawing::Point(24, 517);
			this->BotaoVoltarMenu->Name = L"BotaoVoltarMenu";
			this->BotaoVoltarMenu->Size = System::Drawing::Size(164, 71);
			this->BotaoVoltarMenu->TabIndex = 18;
			this->BotaoVoltarMenu->UseVisualStyleBackColor = false;
			this->BotaoVoltarMenu->Click += gcnew System::EventHandler(this, &TelaTeoria3::BotaoVoltarMenu_Click_1);
			// 
			// btn_Avancar
			// 
			...
			this->btn_Avancar->Location = System::Drawing::Point(853, 528);
			this->btn_Avancar->Name = L"btn_Avancar";
			this->btn_Avancar->Size = System::Drawing::Size(164, 60);
			this->btn_Avancar->TabIndex = 19;
			this->btn_Avancar->UseVisualStyleBackColor = false;
			this->btn_Avancar->Click += gcnew System::EventHandler(this, &TelaTeoria3::btn_Avancar_Click_1);
			// 
			// pictureBox1
			// 
			this->pictureBox1->BackColor = System::Drawing::Color::Transparent;
			this->pictureBox1->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"pictureBox1.Image")));
			this->pictureBox1->Location = System::Drawing::Point(644, 200);
			...
			this->Name = L"TelaTeoria3";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"TelaTeoria3";
			this->Load += gcnew System::EventHandler(this, &TelaTeoria3::TelaTeoria3_Load);
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->pictureBox1))->EndInit();
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void TelaTeoria3_Load(System::Object^  sender, System::EventArgs^  e) {
	}
	private: System::Void btn_Avancar_Click_1(System::Object^  sender, System::EventArgs^  e)
	{
		this->Visible = false;
		Close();
		TelaTeoria4 telateoria4;
		telateoria4.ShowDialog();
		this->Visible = true;
	}
