...
namespace ProjetoCaixeiroViajante {
	...
	/// <summary>
	/// Summary for TelaTeoria10
	/// </summary>
	public ref class TelaTeoria10 : public System::Windows::Forms::Form
	{
	public:
		TelaTeoria10(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(TelaTeoria10::typeid));
			...
			this->btn_Avancar->Click += gcnew System::EventHandler(this, &TelaTeoria10::btn_Avancar_Click_1);
			// 
			// BotaoVoltarMenu
			// 
			...
			this->BotaoVoltarMenu->Click += gcnew System::EventHandler(this, &TelaTeoria10::BotaoVoltarMenu_Click_1);
			// 
			// TelaTeoria10
			// 
			...
			this->Name = L"TelaTeoria10";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"TelaTeoria10";
			this->Load += gcnew System::EventHandler(this, &TelaTeoria10::TelaTeoria10_Load);
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void TelaTeoria10_Load(System::Object^  sender, System::EventArgs^  e) {
	}
	...
	private: System::Void btn_Avancar_Click_1(System::Object^  sender, System::EventArgs^  e)
	{
		this->Visible = false;
		Close();
		TelaTeoria11 telateoria11;
		telateoria11.ShowDialog();
		this->Visible = true;
	}
