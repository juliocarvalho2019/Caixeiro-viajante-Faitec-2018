...
namespace ProjetoCaixeiroViajante {
	...
	/// <summary>
	/// Summary for TeleTeoria2
	/// </summary>
	public ref class TeleTeoria2 : public System::Windows::Forms::Form
	{
	public:
		TeleTeoria2(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(TeleTeoria2::typeid));
			...
			this->btn_Avancar->Location = System::Drawing::Point(855, 530);
			this->btn_Avancar->Name = L"btn_Avancar";
			this->btn_Avancar->Size = System::Drawing::Size(164, 60);
			this->btn_Avancar->TabIndex = 16;
			this->btn_Avancar->UseVisualStyleBackColor = false;
			this->btn_Avancar->Click += gcnew System::EventHandler(this, &TeleTeoria2::btn_Avancar_Click);
			// 
			// BotaoVoltarMenu
			// 
			...
			this->BotaoVoltarMenu->Location = System::Drawing::Point(28, 519);
			this->BotaoVoltarMenu->Name = L"BotaoVoltarMenu";
			this->BotaoVoltarMenu->Size = System::Drawing::Size(164, 71);
			this->BotaoVoltarMenu->TabIndex = 17;
			this->BotaoVoltarMenu->UseVisualStyleBackColor = false;
			this->BotaoVoltarMenu->Click += gcnew System::EventHandler(this, &TeleTeoria2::BotaoVoltarMenu_Click);
			// 
			// pictureBox1
			// 
			this->pictureBox1->BackColor = System::Drawing::Color::Transparent;
			this->pictureBox1->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"pictureBox1.Image")));
			this->pictureBox1->Location = System::Drawing::Point(727, 189);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(152, 153);
			...
			this->ClientSize = System::Drawing::Size(1045, 597);
			...
			this->Name = L"TeleTeoria2";
			this->SizeGripStyle = System::Windows::Forms::SizeGripStyle::Show;
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"TeleTeoria2";
			this->Load += gcnew System::EventHandler(this, &TeleTeoria2::TeleTeoria2_Load);
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->pictureBox1))->EndInit();
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void TeleTeoria2_Load(System::Object^  sender, System::EventArgs^  e) {
	}
...
private: System::Void btn_Avancar_Click(System::Object^  sender, System::EventArgs^  e) 
{
	this->Visible = false;
	Close();
	TelaTeoria3 telateoria3;
	telateoria3.ShowDialog();
	this->Visible = true;
}
};
}
