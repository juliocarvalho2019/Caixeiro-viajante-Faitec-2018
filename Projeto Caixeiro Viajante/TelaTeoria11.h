...
namespace ProjetoCaixeiroViajante {
	...
	/// <summary>
	/// Summary for TelaTeoria11
	/// </summary>
	public ref class TelaTeoria11 : public System::Windows::Forms::Form
	{
	public:
		TelaTeoria11(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(TelaTeoria11::typeid));
			...
			this->btn_Avancar->Click += gcnew System::EventHandler(this, &TelaTeoria11::btn_Avancar_Click_1);
			// 
			// BotaoVoltarMenu
			// 
			...
			this->BotaoVoltarMenu->Click += gcnew System::EventHandler(this, &TelaTeoria11::BotaoVoltarMenu_Click_1);
			// 
			// TelaTeoria11
			// 
			...
			this->Name = L"TelaTeoria11";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"TelaTeoria11";
			this->Load += gcnew System::EventHandler(this, &TelaTeoria11::TelaTeoria11_Load);
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void TelaTeoria11_Load(System::Object^  sender, System::EventArgs^  e) {
	}
	...
	private: System::Void btn_Avancar_Click_1(System::Object^  sender, System::EventArgs^  e) 
	{
		this->Visible = false;
		Close();
		TelaTeoria12 telateoria12;
		telateoria12.ShowDialog();
		this->Visible = true;
	}
