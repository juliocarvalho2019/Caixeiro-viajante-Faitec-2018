...
namespace ProjetoCaixeiroViajante {
	...
	/// <summary>
	/// Summary for TelaTeoria4
	/// </summary>
	public ref class TelaTeoria4 : public System::Windows::Forms::Form
	{
	public:
		TelaTeoria4(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(TelaTeoria4::typeid));
			...
			this->btn_Avancar->Location = System::Drawing::Point(853, 529);
			...
			this->btn_Avancar->Click += gcnew System::EventHandler(this, &TelaTeoria4::btn_Avancar_Click_1);
			// 
			// BotaoVoltarMenu
			// 
			...
			this->BotaoVoltarMenu->Click += gcnew System::EventHandler(this, &TelaTeoria4::BotaoVoltarMenu_Click_1);
			// 
			// TelaTeoria4
			// 
			...
			this->Name = L"TelaTeoria4";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"TelaTeoria4";
			this->Load += gcnew System::EventHandler(this, &TelaTeoria4::TelaTeoria4_Load);
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void TelaTeoria4_Load(System::Object^  sender, System::EventArgs^  e) {
	}
	...
	private: System::Void btn_Avancar_Click_1(System::Object^  sender, System::EventArgs^  e) 
	{
		this->Visible = false;
		Close();
		TelaTeoria5 telateoria5;
		telateoria5.ShowDialog();
		this->Visible = true;
	}
