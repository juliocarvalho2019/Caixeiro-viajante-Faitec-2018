...
namespace ProjetoCaixeiroViajante {
	...
	/// <summary>
	/// Summary for TelaTeoria9
	/// </summary>
	public ref class TelaTeoria9 : public System::Windows::Forms::Form
	{
	public:
		TelaTeoria9(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(TelaTeoria9::typeid));
			...
			this->btn_Avancar->Click += gcnew System::EventHandler(this, &TelaTeoria9::btn_Avancar_Click_1);
			// 
			// BotaoVoltarMenu
			// 
			...
			this->BotaoVoltarMenu->Click += gcnew System::EventHandler(this, &TelaTeoria9::BotaoVoltarMenu_Click_1);
			// 
			// TelaTeoria9
			// 
			...
			this->Name = L"TelaTeoria9";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"TelaTeoria9";
			this->Load += gcnew System::EventHandler(this, &TelaTeoria9::TelaTeoria9_Load);
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void TelaTeoria9_Load(System::Object^  sender, System::EventArgs^  e) {
	}
	...
	private: System::Void btn_Avancar_Click_1(System::Object^  sender, System::EventArgs^  e)
	{
		this->Visible = false;
		Close();
		TelaTeoria10 telateoria10;
		telateoria10.ShowDialog();
		this->Visible = true;
	}
